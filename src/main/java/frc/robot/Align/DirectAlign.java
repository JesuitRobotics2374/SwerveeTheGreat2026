...
public class DirectAlign extends Command {
    ...
    public DirectAlign(CommandSwerveDrivetrain drivetrain, VisionSubsystem visionSubsystem) {
    ...
    public DirectAlign(CommandSwerveDrivetrain drivetrain, VisionSubsystem visionSubsystem, Target target) {
        System.out.println("DirectAlign created");
        finishedOverride = false;
